...
# @receiver(pre_save, sender=Basket) в модели корзины уже предусмотрен метод save
...
# @receiver(pre_delete, sender=Basket)  в модели корзины уже предусмотрен метод delete
