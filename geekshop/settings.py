...
SECRET_KEY = 'django-insecure-$q%@3h0o3ybnzj#_qgm(_p1=&%e&p$8645v00bionjpw9c&sw8'
...
# бекенды для аутентификации:
AUTHENTICATION_BACKENDS = (
    'django.contrib.auth.backends.ModelBackend',
    'social_core.backends.vk.VKOAuth2',
)

LOGIN_ERROR_URL = '/'  # переадресация сюда при ошибке

SOCIAL_AUTH_VK_OAUTH2_IGNORE_DEFAULT_SCOPE = True
SOCIAL_AUTH_VK_OAUTH2_SCOPE = ['email']  # получение почты из социалки, при подключении
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'authapp.pipeline.save_user_profile',  # собственный pipeline
...
# на login_url будет пересылать декортатор @login_required
